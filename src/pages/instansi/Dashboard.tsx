...
import { Search, ListFilter, LogOut, Calendar, Building, User } from 'lucide-react';
import InputNilaiPembimbingInstansi from "../../components/Modal/InputNilai.PembimbingInstansi";
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="pt-20 px-8 pb-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <div>
                        <h1 className="text-3 xl font-semibold mb-2">Selamat Datang, PT. Technology Indonesia</h1>
