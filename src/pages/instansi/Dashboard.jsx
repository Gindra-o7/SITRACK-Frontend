...
import { Search, ListFilter, LogOut, Calendar, Clock, Building, User } from 'lucide-react';
import InputNilaiPembimbingInstansi from "../../components/Modal/InputNilai.PembimbingInstansi.jsx";
import Notification from "../../components/Notification.jsx";
import LihatNilai from "../../components/Modal/LihatNilai.jsx";
import { useNavigate } from "react-router-dom";
import Logout from "../../components/Modal/Logout.jsx";

const DashboardPembimbingInstansi = () => {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="pt-20 px-8 pb-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-semibold mb-2">Selamat Datang, PT. Technology Indonesia</h1>
                ...
                <div className="bg-white rounded-lg shadow-sm">
                    <div className="p-6 border-b border-gray-200">
                        <h2 className="text-lg font-medium mb-4">Daftar Mahasiswa Kerja Praktik</h2>
