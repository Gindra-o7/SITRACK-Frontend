...
const Pengajuan: React.FC = () => {
    ...
    const [isPendaftaranDitolakModalOpen, setIsPendaftaranDitolakModalOpen] = useState<boolean>(false);
    const [isPendaftaranDiterimaModalOpen, setIsPendaftaranDiterimaModalOpen] = useState<boolean>(false);
    ...
    const handleStatusClick = (status: "revisi" | "diterima" | "menunggu", notes?: string[]) => {
        if (activeStep === 1) {
            if (status === "revisi") {
