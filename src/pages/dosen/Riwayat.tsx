...
import { Search, ListFilter, Calendar, Building, User, FileText } from 'lucide-react';
...
const Riwayat: React.FC = () => {
  ...
  <main className="py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div className="mb-8 text-center sm:text-left">
      <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800">Riwayat Bimbingan</h1>
    ...
    {filteredData.map((period, periodIndex) => (
      <div key={periodIndex} className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">{period.period}</h2>
          ...
          {period.students.map((student, studentIndex) => (
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-start mb-4">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800">{student.name}</h3>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-semibold text-blue-600">{student.finalGrade}</p>
                </div>
