...
import {
    UploadPersyaratanProps,
    DocumentUpload,
    UploadPendaftaranProps,
    FormDataType,
    DocumentPendaftaran,
    UploadPascaSeminarProps
} from "../../interfaces/common.interfaces.ts";
...
export const UploadPascaSeminar: React.FC<UploadPascaSeminarProps> = ({
    ...
    const uploadDocument = async (doc: DocumentUpload) => {
        ...
        formData.append('userId', String(userId));
        formData.append('jenisDokumen', doc.jenisDokumen);
        formData.append('kategori', 'PASCA_SEMINAR');
