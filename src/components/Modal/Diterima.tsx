...
import { X, MoveRight, File } from "lucide-react";
import { useNavigate } from "react-router-dom";

interface DiterimaProps {
  title: string;
  text?: string; // Opsional jika tidak digunakan
  textButton?: string; // Opsional jika tidak digunakan
  isOpen: boolean;
  onClose: () => void;
  linkTo: string;
}

const Diterima: React.FC<DiterimaProps> = ({
                                             title,
                                             text,
                                             textButton,
                                             isOpen,
