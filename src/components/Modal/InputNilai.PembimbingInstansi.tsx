...
interface InputNilaiPembimbingInstansiProps {
    isOpen: boolean;
    onClose: () => void;
    student?: Student;
}

const InputNilaiPembimbingInstansi: React.FC<InputNilaiPembimbingInstansiProps> = ({
                                                                                       isOpen,
                                                                                       onClose,
                                                                                       student
                                                                                   }) => {
                                            ...
                                            {gradeOptions.map((grade) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 text-sm rounded-lg ${
                                                        selectedGrades[key as keyof Grade] === grade
