...
type GradeInputs = {
    [K in keyof Grades]: string;
};

const InputNilaiDosenPembimbing: React.FC<Props> = ({ isOpen, onClose, student }) => {
    ...
    const gradeInputEntries = (Object.entries(gradeInputs) as [keyof Grades, string][]);
